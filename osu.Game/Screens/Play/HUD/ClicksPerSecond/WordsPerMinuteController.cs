...
{
    public partial class WordsPerMinuteController : Component
    {
        ...
        public WordsPerMinuteController()
        {
        ...
        protected override void Update()
        {
            ...
            // ApproximateWPM = CPS * 12  (since (CPS / 5) * 60 = CPS * 12)
            // Assuming a word is 5 keystrokes
            Value = count * 12;
        }
    }
}
