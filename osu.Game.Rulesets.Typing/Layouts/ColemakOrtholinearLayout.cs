...
{
    public sealed class ColemakOrtholinearLayout : KeyboardLayout
    {
        protected override IEnumerable<LayoutKeyDefinition> CreateLayout()
        {
            ...
            yield return Key(TypingAction.G, 4, 0, Hand.Left, Finger.Index, KeyboardRow.Top);
            ...
            yield return Key(TypingAction.D, 4, 1, Hand.Left, Finger.Index, KeyboardRow.Home);

            yield return Key(TypingAction.H, 5, 1, Hand.Right, Finger.Index, KeyboardRow.Home);
            ...
            // Bottom Row
            yield return Key(TypingAction.Z, 0, 2, Hand.Left, Finger.Pinky, KeyboardRow.Bottom);
            yield return Key(TypingAction.X, 1, 2, Hand.Left, Finger.Ring, KeyboardRow.Bottom);
            yield return Key(TypingAction.C, 2, 2, Hand.Left, Finger.Middle, KeyboardRow.Bottom);
            yield return Key(TypingAction.V, 3, 2, Hand.Left, Finger.Index, KeyboardRow.Bottom);
            yield return Key(TypingAction.B, 4, 2, Hand.Left, Finger.Index, KeyboardRow.Bottom);
